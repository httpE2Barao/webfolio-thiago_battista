                    ...
                    {albuns.map((album) => (
                        ...
                        >
                            ...
                            <div className="aspect-[3/2] relative overflow-hidden">
                                {album.coverImage || album.coverImageDesktop || album.coverImageMobile ? (
                                    <Image
                                        src={getThumbUrl((isMobile && album.coverImageMobile) ? album.coverImageMobile : (album.coverImageDesktop || album.coverImage || ''))}
                                        alt={album.titulo}
                                        fill
                                        style={{
                                            objectPosition: isMobile
                                                ? (album.coverImageMobilePosition || 'center')
                                                : (album.coverImageDesktopPosition || 'center')
                                        }}
